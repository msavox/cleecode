...
1. Tag and push: `git tag v0.1.1 && git push origin v0.1.1`. The Release workflow builds
...
```bash
curl -fsSL https://github.com/msavox/cleecode/archive/refs/tags/v0.1.1.tar.gz | shasum -a 256
```
