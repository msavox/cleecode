...
const EN: &[Page] = &[
    ...
    ("Markdown", &[
        ...
        "",
        "Dark is offered on documents only — inverting a photograph is not a",
        "mode, it is a negative — and it is remembered: turn it on once and",
        "the next document opens that way too.",
        "",
...
const IT: &[Page] = &[
    ...
    ("Markdown", &[
        ...
        "",
        "Lo scuro c'è solo sui documenti — invertire una fotografia non è una",
        "modalità, è un negativo — e viene ricordato: attivalo una volta e il",
        "documento dopo si apre già così.",
        "",
