...
const EN: &[Page] = &[
    ...
    ("Terminals", &[
        ...
        "",
        "While a full-screen program (vim, less, a pager) has the screen,",
        "there is no history to walk and the wheel is left to that program.",
        "",
...
const IT: &[Page] = &[
    ...
    ("Terminali", &[
        ...
        "già in esecuzione.",
        "",
        "Finché un programma a tutto schermo (vim, less, un pager) tiene lo",
        "schermo non c'è cronologia da scorrere, e la rotellina resta a lui.",
        "",
